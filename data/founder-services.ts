...
export const FOUNDER_SERVICE_PLANS: FounderServicePlan[] = [
  ...
  },
  {
    ...
    shortDescription: 'For straightforward placement where a verified badge is unavailable, difficult to verify, or cannot be added by a free-submission user.',
  ...
  },
  {
    ...
    shortDescription: 'For a stronger middle-tier placement with additional visibility or handling.',
  ...
  },
  {
    id: 'spotlight_pro',
    name: 'Spotlight Pro',
    shortDescription: 'For complex submissions, enhanced Spotlight placement, or more involved workflows.',
    ...
    ctaLabel: 'Get Spotlight Pro - $29.00',
