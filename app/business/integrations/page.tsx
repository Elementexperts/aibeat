...
import { decideBusinessApprovalAction, runBusinessWorkflowAction, updateBusinessIntegrationAction } from '@/app/business/actions'
...
export default async function BusinessIntegrationsPage() {
  ...
  return <BusinessWorkspace route="integrations" initialData={data} onRunWorkflow={runBusinessWorkflowAction} onDecideApproval={decideBusinessApprovalAction} onUpdateIntegration={updateBusinessIntegrationAction} />
}
