...
import { decideBusinessApprovalAction, runAgentEvaluationHarnessAction, runBusinessWorkflowAction } from '@/app/business/actions'
...
export default async function BusinessReportsPage() {
  ...
  return <BusinessWorkspace route="reports" initialData={data} onRunWorkflow={runBusinessWorkflowAction} onDecideApproval={decideBusinessApprovalAction} onRunEvaluations={runAgentEvaluationHarnessAction} />
}
