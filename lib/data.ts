...
export const TOOLS: Tool[] = [
  ...
  // - Submitted tools: 2026-08-27 -
  {
    slug: 'video-upscaler',
    name: 'Video Upscaler',
    tagline: 'AI video enhancement and upscaling for sharper HD and 4K footage',
    description: 'Video Upscaler is an online AI video enhancement tool for improving blurry, compressed, noisy, or low-resolution footage. It supports HD and 4K output with enhancement modes for general footage, denoising, face restoration, and anime.',
    category: 'AI Video',
    logo: '#2563eb',
    logoInitials: 'VU',
    ...
    featured: false,
    pros: ['Supports HD and 4K video enhancement', 'Multiple enhancement modes for different footage', 'Face restoration and denoising options', 'Credits do not expire'],
    cons: ['More demanding processing uses more credits', '4K and intensive enhancement can cost more credits', 'Results depend on the quality of the source footage'],
    alternatives: ['runway', 'pictory', 'descript'],
  },
  {
    ...
    description: 'Vedic Astrology Chart generates sidereal Vedic birth charts from birth details and helps users explore planetary placements, divisional charts, traditional Jyotish concepts, and AI-assisted astrology interpretations and reports.',
    category: 'AI Lifestyle',
    logo: '#7c3aed',
    logoInitials: 'VA',
    logoUrl: 'https://www.google.com/s2/favicons?domain=vedicastrologychart.net&sz=128',
    rating: 4.0,
    pricing: 'Free chart; paid digital reports available',
    pricingType: 'freemium',
    affiliateUrl: 'https://vedicastrologychart.net/',
    websiteUrl: 'https://vedicastrologychart.net/',
    featured: false,
    pros: ['Free Vedic birth chart generation', 'AI-assisted astrology interpretations', 'Supports divisional charts and traditional Jyotish concepts', 'Paid reports can be viewed and downloaded digitally'],
    cons: ['Astrology interpretations are for educational and entertainment use', 'Detailed reports may require payment', 'Accurate birth details are important for chart calculations'],
    alternatives: ['chatgpt', 'gemini', 'perplexity'],
  },
  {
    slug: 'sharpniq',
    name: 'Sharpniq',
    tagline: 'Private AI image unblurring and clarity enhancement in the browser',
    description: 'Sharpniq is an AI-powered image restoration tool focused on sharpening blurry photos and improving visible clarity. It offers free browser-based processing for supported images and an optional cloud enhancement workflow for stronger restoration.',
    category: 'AI Image',
    logo: '#0f766e',
    logoInitials: 'SQ',
    logoUrl: 'https://www.google.com/s2/favicons?domain=unblurimage.me&sz=128',
    rating: 4.0,
    pricing: 'Free browser processing; optional cloud enhancement',
    pricingType: 'freemium',
    affiliateUrl: 'https://unblurimage.me/',
    websiteUrl: 'https://unblurimage.me/',
    featured: false,
    pros: ['Free local browser processing option', 'Focused on unblurring and sharpening photos', 'Optional cloud enhancement for stronger restoration', 'Simple browser-based workflow'],
    cons: ['Results depend on the source image and blur type', 'Cloud processing is optional and separate from local mode', 'Not a full photo editing suite'],
    alternatives: ['dall-e', 'leonardo-ai', 'stable-diffusion'],
  },
  {
    slug: 'image-describer',
    name: 'Image Describer',
    tagline: 'AI image analysis for descriptions, alt text, OCR and creative prompts',
    description: 'Image Describer analyzes images with AI to generate detailed descriptions, accessibility alt text, OCR text, SEO content, object recognition, social content, and creative prompts for image-generation workflows.',
    category: 'AI Image',
    logo: '#2563eb',
    logoInitials: 'ID',
    ...
    featured: false,
    pros: ['Multiple image analysis modes', 'Generates accessibility alt text and SEO descriptions', 'OCR and object recognition included', 'Batch processing and structured exports available'],
    cons: ['Advanced models and batch features use paid credits', 'AI-generated descriptions should be reviewed for accuracy', 'Higher-volume workflows consume additional credits'],
    alternatives: ['chatgpt', 'gemini', 'dall-e'],
  },
  {
    slug: 'blur-background',
    name: 'Blur Background',
    tagline: 'AI-assisted background blur with private local photo processing',
    description: 'Blur Background is an online photo tool for keeping a main subject clear while softening the surrounding background. Its Free Basic mode processes supported photos locally in the browser, with an optional AI Refined workflow for more advanced subject separation.',
    category: 'AI Image',
    logo: '#6366f1',
    logoInitials: 'BB',
    logoUrl: 'https://www.google.com/s2/favicons?domain=blurbackground.vip&sz=128',
    rating: 4.0,
    pricing: 'Free Basic; optional AI Refined credits',
    pricingType: 'freemium',
    affiliateUrl: 'https://blurbackground.vip/',
    websiteUrl: 'https://blurbackground.vip/',
    featured: false,
    pros: ['Free local browser-based processing', 'No automatic photo upload in Free Basic mode', 'Adjustable background blur strength', 'Optional AI Refined processing for difficult edges'],
    cons: ['Processes one static photo at a time', 'Complex hair, glass and transparent edges may be imperfect', 'AI Refined processing requires credits'],
    alternatives: ['dall-e', 'leonardo-ai', 'midjourney'],
  },
]
