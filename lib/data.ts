...
export const TOOLS: Tool[] = [
  ...
  },
  {
    slug: 'jpg2excel',
    name: 'JPG2Excel',
    tagline: 'Convert table images into editable spreadsheets',
    description: 'JPG2Excel turns JPG and JPEG images of tables, receipts, and structured data into editable Excel or CSV files. It is useful for students, office teams, small businesses, and researchers who need to extract rows and columns from clear images.',
    category: 'Productivity',
    logo: '#2563eb',
    logoInitials: 'J2',
    logoUrl: 'https://www.google.com/s2/favicons?domain=jpg2excel.app&sz=128',
    rating: 4.0,
    pricing: 'Free online tool',
    pricingType: 'free',
    affiliateUrl: 'https://jpg2excel.app',
    websiteUrl: 'https://jpg2excel.app',
    featured: false,
    pros: ['Converts JPG and JPEG tables to spreadsheets', 'Exports XLSX, XLS, or CSV', 'Works in the browser', 'Helpful for receipts and structured-data images'],
    cons: ['Best results require clear images', 'OCR accuracy may need review', 'Complex layouts can require cleanup'],
    alternatives: ['notion', 'obsidian', 'wave'],
  },
  {
    slug: 'toolsvio',
    name: 'Toolsvio',
    tagline: 'Fast web utilities for daily productivity tasks',
    description: 'Toolsvio organizes everyday utilities for writing, documents, images, calculations, and productivity so users can quickly find focused tools for common online tasks.',
    category: 'Productivity',
    logo: '#0ea5e9',
    logoInitials: 'Tv',
    logoUrl: 'https://www.google.com/s2/favicons?domain=toolsvio.online&sz=128',
    rating: 4.0,
    pricing: 'Free online tools',
    pricingType: 'free',
    affiliateUrl: 'https://www.toolsvio.online/tools',
    websiteUrl: 'https://www.toolsvio.online/tools',
    featured: false,
    pros: ['Wide range of everyday utilities', 'Focused tool pages', 'Includes text PDF image and AI tools', 'Helpful for quick browser-based tasks'],
    cons: ['Tool quality may vary by utility', 'Best for lightweight tasks', 'Advanced workflow depth may be limited'],
    alternatives: ['jpg2excel', 'notion', 'obsidian'],
  },
  // — Invoicing —
  {
    slug: 'freshbooks',
  ...
  },
  {
    slug: 'timbercloud',
    name: 'TimberCloud',
    tagline: 'Connected storefront-to-shop-floor system for custom manufacturers',
    description: 'TimberCloud helps cabinet shops, door manufacturers, and millwork teams turn configurable customer orders into production-ready workflows with pricing, order intake, cut sheets, BOMs, and shipment coordination.',
    category: 'Sales',
    logo: '#16a34a',
    logoInitials: 'TC',
    logoUrl: 'https://www.google.com/s2/favicons?domain=timbercloud.com&sz=128',
    rating: 4.0,
    pricing: 'Free listing submitted',
    pricingType: 'paid',
    affiliateUrl: 'https://timbercloud.com',
    websiteUrl: 'https://timbercloud.com',
    featured: false,
    pros: ['Connects storefront orders to production', 'Built for custom manufacturers', 'Supports configurable product workflows', 'Can reduce back-and-forth order handling'],
    cons: ['Best fit is niche manufacturing teams', 'Pricing details need review', 'Implementation may depend on catalog complexity'],
    alternatives: ['hubspot', 'pipedrive', 'monday'],
  },
  // — AI Coding —
  {
    slug: 'cursor',
  ...
  },
  {
    slug: 'agentarius',
    name: 'Agentarius',
    tagline: 'Independent AI tool research and comparison guide',
    description: 'Agentarius helps professionals and teams find, compare, and choose AI tools with independently researched reviews, plain-English comparisons, role-based recommendations, and curated AI stacks.',
    category: 'Research',
    logo: '#2563eb',
    logoInitials: 'Ag',
    logoUrl: 'https://www.google.com/s2/favicons?domain=agentarius.ai&sz=128',
    rating: 4.0,
    pricing: 'Free research guide',
    pricingType: 'free',
    affiliateUrl: 'https://agentarius.ai/',
    websiteUrl: 'https://agentarius.ai/',
    featured: false,
    pros: ['Independent tool reviews', 'Plain-English comparisons', 'Role-based AI stack recommendations', 'Covers pricing and privacy factors'],
    cons: ['Coverage depth may vary by category', 'Recommendations still need workflow fit review', 'No sponsored rankings claim requires ongoing trust'],
    alternatives: ['perplexity', 'chatgpt', 'notion'],
  },
  {
    slug: 'partgenie',
    name: 'PartGenie',
    tagline: 'AI hardware companion for component search and BOM optimization',
    description: 'PartGenie helps hardware engineers, R&D teams, and procurement professionals search electronic components, analyze datasheets with AI, compare technical tradeoffs, find compatible alternatives, and spot BOM lifecycle and sourcing risks.',
    category: 'AI Agents',
    logo: '#0f766e',
    logoInitials: 'PG',
    logoUrl: 'https://www.google.com/s2/favicons?domain=partgenie.ai&sz=128',
    rating: 4.4,
    pricing: 'Free featured option',
    pricingType: 'free',
    affiliateUrl: 'https://www.partgenie.ai/',
    websiteUrl: 'https://www.partgenie.ai/',
    featured: true,
    pros: ['Natural-language component search', 'AI datasheet analysis', 'BOM optimization support', 'Sourcing and lifecycle risk checks'],
    cons: ['Best fit is hardware and procurement teams', 'Component data should be verified before purchasing', 'Workflow depth depends on uploaded design context'],
    alternatives: ['perplexity', 'chatgpt', 'replit'],
  },
  ...
  },
  {
    slug: 'dzyn-space',
    name: 'Dzyn Space',
    tagline: 'Collaborative creative workspace for marketing content',
    description: 'Dzyn Space helps teams create marketing content in one collaborative space, giving brands a more connected workflow for design, creative production, and campaign assets.',
    category: 'Design',
    logo: '#0f766e',
    logoInitials: 'DS',
    logoUrl: 'https://www.google.com/s2/favicons?domain=dzynspace.co.nz&sz=128',
    rating: 4.0,
    pricing: 'Free listing submitted',
    pricingType: 'freemium',
    affiliateUrl: 'https://dzynspace.co.nz/',
    websiteUrl: 'https://dzynspace.co.nz/',
    featured: false,
    pros: ['Collaborative creative workspace', 'Focused on marketing content', 'Useful for team workflows', 'Helps centralize campaign assets'],
    cons: ['New platform with limited public track record', 'Pricing details may need review', 'Best fit depends on team workflow'],
    alternatives: ['midjourney', 'dall-e', 'leonardo-ai'],
  },
  // - AI Video and Audio -
  {
  ...
  },
  {
    slug: 'aio-geo',
    name: 'AIO.GEO',
    tagline: 'AI search readiness audits for brands and agencies',
    description: 'AIO.GEO helps GEO and SEO teams audit what AI crawlers can see, generate preview-first fix packs, rescore pages, and prove before-and-after changes with signed receipts.',
    category: 'AI Infrastructure',
    logo: '#2563eb',
    logoInitials: 'AG',
    logoUrl: 'https://www.google.com/s2/favicons?domain=aiogeoprotocol.com&sz=128',
    rating: 4.0,
    pricing: 'Free public audit available',
    pricingType: 'freemium',
    affiliateUrl: 'https://www.aiogeoprotocol.com',
    websiteUrl: 'https://www.aiogeoprotocol.com',
    featured: false,
    pros: ['Audits AI crawler visibility', 'Preview-first fix packs', 'Before-and-after receipts', 'CLI and MCP workflows for technical teams'],
    cons: ['Technical workflow may not fit beginners', 'Does not measure or sell LLM rankings', 'Best for public sites with structured data needs'],
    alternatives: ['semrush', 'ahrefs', 'openai-api'],
  },
  {
    slug: 'openai-api',
    name: 'OpenAI API',
  ...
  slug: 'video-upscaler',
  name: 'Video Upscaler',
  tagline: 'AI video enhancement and upscaling for sharper HD and 4K footage',
  description: 'Video Upscaler is an online AI video enhancement tool for improving blurry, compressed, noisy, or low-resolution footage. It supports HD and 4K output with enhancement modes for general footage, faces, denoising, and anime.',
  category: 'Video',
  logo: '#2563eb',
  logoInitials: 'VU',
  logoUrl: 'https://www.google.com/s2/favicons?domain=videoupscaler.video&sz=128',
  rating: 4.4,
  pricing: 'Credit-based pricing',
  pricingType: 'paid',
  affiliateUrl: 'https://videoupscaler.video/',
  websiteUrl: 'https://videoupscaler.video/',
  featured: false,
  pros: [
    'Supports HD and 4K video enhancement',
    'Multiple enhancement modes for different footage',
    'Face restoration and denoising options',
    'Credits do not expire'
  ],
  cons: [
    'More demanding processing uses more credits',
    '4K and intensive enhancement can cost more credits',
    'Results depend on the quality of the source footage'
  ],
  alternatives: [],
},
{
  ...
  tagline: 'AI-assisted Vedic birth charts and personalized astrology reports',
  description: 'Vedic Astrology Chart generates Vedic birth charts with planetary positions, signs, Nakshatras and detected yogas, combining traditional chart calculations with AI-assisted interpretations and optional detailed reports.',
  category: 'AI Lifestyle',
  logo: '#7c3aed',
  logoInitials: 'VA',
  logoUrl: 'https://www.google.com/s2/favicons?domain=vedicastrologychart.net&sz=128',
  rating: 4.4,
  pricing: 'Free chart; paid reports available',
  pricingType: 'freemium',
  affiliateUrl: 'https://vedicastrologychart.net/',
  websiteUrl: 'https://vedicastrologychart.net/',
  featured: false,
  pros: [
    'Free Vedic birth chart available',
    'AI-assisted chart interpretation',
    'Includes planetary positions, Nakshatras and yogas',
    'Detailed downloadable reports available'
  ],
  cons: [
    'Deeper interpretations require paid reports',
    'Astrology interpretations should not replace professional advice',
    'Primarily useful for users interested in Vedic astrology'
  ],
  alternatives: [],
},
{
  ...
  tagline: 'AI image analysis for descriptions, alt text, OCR and creative prompts',
  description: 'Image Describer analyzes images with AI to generate detailed descriptions, accessibility alt text, OCR text, SEO content, object recognition and creative prompts for image-generation workflows.',
  category: 'Image',
  logo: '#2563eb',
  logoInitials: 'ID',
  logoUrl: 'https://www.google.com/s2/favicons?domain=imagedescriber.dev&sz=128',
  rating: 4.4,
  pricing: 'Free plan; paid credits and subscriptions available',
  pricingType: 'freemium',
  affiliateUrl: 'https://imagedescriber.dev/',
  websiteUrl: 'https://imagedescriber.dev/',
  featured: false,
  pros: [
    'Multiple image analysis modes',
    'Generates accessibility alt text and SEO descriptions',
    'OCR and object recognition included',
    'Batch processing and structured exports available'
  ],
  cons: [
    'Advanced models and batch features require paid credits',
    'AI-generated descriptions should be reviewed for accuracy',
    'Higher-volume workflows consume additional credits'
  ],
  alternatives: [],
},
{
  ...
  tagline: 'AI-assisted background blur with private local photo processing',
  description: 'Blur Background is an online photo tool for keeping the main subject clear while softening the surrounding background. Its Free Basic mode processes photos locally in the browser, with an optional AI Refined workflow for more advanced subject separation.',
  category: 'Image',
  logo: '#6366f1',
  logoInitials: 'BB',
  logoUrl: 'https://www.google.com/s2/favicons?domain=blurbackground.vip&sz=128',
  rating: 4.4,
  pricing: 'Free basic processing; optional paid AI credits',
  pricingType: 'freemium',
  affiliateUrl: 'https://blurbackground.vip/',
  websiteUrl: 'https://blurbackground.vip/',
  featured: false,
  pros: [
    'Free local browser-based processing',
    'No automatic photo upload in Free Basic mode',
    'Adjustable background blur strength',
    'Optional AI Refined processing for difficult edges'
  ],
  cons: [
    'Processes one static photo at a time',
    'Complex hair, glass and transparent edges may be imperfect',
    'AI Refined processing requires credits'
  ],
  alternatives: [],
},
{
  slug: 'vidirelay',
  name: 'VidiRelay',
  tagline: 'Turn videos into editable transcripts, subtitles and reusable content',
  description: 'VidiRelay is a video transcription and content repurposing workspace that turns public video links and uploaded media into editable, timestamped transcripts. Users can review, organize and export transcripts, then use optional AI tools to create summaries, captions, hooks and script rewrites.',
  category: 'Video',
  logo: '#2563eb',
  logoInitials: 'VR',
  logoUrl: 'https://www.google.com/s2/favicons?domain=vidirelay.com&sz=128',
  rating: 4.4,
  pricing: 'Free access; credit-based features available',
  pricingType: 'freemium',
  affiliateUrl: 'https://vidirelay.com/',
  websiteUrl: 'https://vidirelay.com/',
  featured: false,
  pros: [
    'Supports YouTube, TikTok, Instagram and Facebook public videos',
    'Processes individual videos, batches and uploaded media',
    'Editable timestamped transcripts with multiple export formats',
    'AI tools for summaries, captions, hooks and script rewrites'
  ],
  cons: [
    'Private and login-restricted video sources are not supported',
    'Transcription accuracy can depend on source audio quality',
  ...
  },
  {
    slug: 'rizz-invites',
    name: 'Rizz Invites',
    tagline: 'AI-assisted digital invitations with RSVPs and reminders',
    description: 'Rizz Invites helps people create and send digital invitations by email or SMS, with AI invitation generation, custom design uploads, RSVP tracking, and automatic reminders.',
    category: 'AI Marketing',
    logo: '#ec4899',
    logoInitials: 'RI',
    logoUrl: 'https://www.google.com/s2/favicons?domain=rizzinvites.com&sz=128',
    rating: 4.4,
    pricing: 'Free for 10 guests',
    pricingType: 'freemium',
    affiliateUrl: 'https://rizzinvites.com/',
    websiteUrl: 'https://rizzinvites.com/',
    featured: false,
    pros: ['AI invitation generator', 'SMS and email sending', 'Digital RSVPs', 'Automatic reminders'],
    cons: ['Best for event invitations only', 'Free use is guest-limited', 'Design flexibility depends on template or upload quality'],
    alternatives: ['local-basics', 'hubspot', 'copy-ai'],
  },
  {
    slug: 'alchemy-leads',
    name: 'Alchemy Leads',
    ...
    logo: '#111827',
    logoInitials: 'AL',
    logoUrl: 'https://www.google.com/s2/favicons?domain=alchemyleads.com&sz=128',
    rating: 4.5,
    pricing: 'Custom / from $4,000/mo',
    pricingType: 'paid',
    affiliateUrl: 'https://alchemyleads.com/',
    websiteUrl: 'https://alchemyleads.com/',
    featured: false,
    pros: ['GEO and AEO focus', 'SEO and paid media services', 'Digital PR and content strategy', 'Analytics and attribution support'],
    cons: ['Agency pricing is not for every budget', 'Requires sales consultation', 'Best fit for established growth teams'],
    alternatives: ['semrush', 'ahrefs', 'local-basics'],
  },
  {
    slug: 'vidsyndicate',
    name: 'VidSyndicate',
    tagline: 'Social media publishing platform for video and social content',
    description: 'VidSyndicate gives creators, startups, and businesses a centralized place to prepare, schedule, and distribute video and social content across connected channels after content is created.',
    category: 'AI Marketing',
    logo: '#2563eb',
    logoInitials: 'VS',
    logoUrl: 'https://www.google.com/s2/favicons?domain=vidsyndicate.com&sz=128',
    rating: 4.4,
    pricing: 'Free featured option',
    pricingType: 'free',
    affiliateUrl: 'https://vidsyndicate.com/',
    websiteUrl: 'https://vidsyndicate.com/',
    featured: true,
    pros: ['Centralized social publishing', 'Video and social content workflows', 'Scheduling and distribution support', 'Useful after AI-assisted content creation'],
    cons: ['Not an AI video generator itself', 'Fit depends on connected channels', 'Teams still need editorial review before publishing'],
  ...
  },
  {
    slug: 'avenyora',
    name: 'Avenyora',
    tagline: 'Privacy-first AI astrology, tarot and numerology for self-reflection',
    description: 'Avenyora combines AI-assisted astrology, tarot, numerology, compatibility insights and daily spiritual guidance in a privacy-first experience designed for thoughtful self-reflection and entertainment. Users can access free tools and explore personalized readings and spiritual chat based on a saved cosmic profile.',
    category: 'AI Lifestyle',
    logo: '#312e81',
    logoInitials: 'A',
    logoUrl: 'https://www.google.com/s2/favicons?domain=avenyora.com&sz=128',
    rating: 4.3,
    pricing: 'Free tools · Premium readings available',
    pricingType: 'freemium',
    affiliateUrl: 'https://avenyora.com/',
    websiteUrl: 'https://avenyora.com/',
    featured: false,
    pros: [
      'Privacy-first positioning',
      'Combines astrology, tarot and numerology in one experience',
      'Free tools available',
      'Personalized self-reflection features',
    ],
    cons: [
      'Spiritual guidance may not appeal to every user',
      'Premium personalized features may require payment',
      'Intended for self-reflection and entertainment rather than professional advice',
    ],
    alternatives: [],
  },
  {
    slug: 'stream-bot',
    name: 'Stream Bot',
    tagline: 'Find promising Twitch and Kick moments for human-reviewed clips',
    description: 'Stream Bot helps streamers, clippers, fan accounts, and short-form editors surface promising moments in selected Twitch and Kick VODs using chat and audio activity. It sends a 60-76 second source clip to Telegram for human review before editing or publishing.',
    category: 'Video',
    logo: '#7c3aed',
    logoInitials: 'SB',
    logoUrl: 'https://www.google.com/s2/favicons?domain=stream-bot-clips.blairbro-snan5578czh.chatgpt.site&sz=128',
    rating: 4.4,
    pricing: 'Free access',
    pricingType: 'free',
    affiliateUrl: 'https://stream-bot-clips.blairbro-snan5578czh.chatgpt.site/',
    websiteUrl: 'https://stream-bot-clips.blairbro-snan5578czh.chatgpt.site/',
    featured: false,
    pros: [
      'Surfaces clip candidates from Twitch and Kick VODs',
      'Uses chat and audio activity as discovery signals',
      'Sends source clips to Telegram for review',
      'Keeps a human approval step before publishing',
    ],
    cons: [
      'Candidates still require human editorial review',
      'Limited to supported Twitch and Kick VOD workflows',
      'A Telegram workflow is required for clip delivery',
    ],
    alternatives: ['vidirelay', 'vidsyndicate'],
  },
  {
    slug: 'reverse-image-location',
    name: 'Reverse Image Location',
    tagline: 'Estimate where a photo was taken from visible geographic clues',
    description: 'Reverse Image Location, also presented as GeoSolver, analyzes photos and screenshots for geographic evidence such as signs, road markings, vegetation, terrain, architecture, and map context. It explains its reasoning so users can verify location hypotheses with maps and other evidence.',
    category: 'Research',
    logo: '#0f766e',
    logoInitials: 'RL',
    logoUrl: 'https://www.google.com/s2/favicons?domain=reverseimagelocation.com&sz=128',
    rating: 4.4,
    pricing: 'Free preview; premium plan available',
    pricingType: 'freemium',
    affiliateUrl: 'https://reverseimagelocation.com/',
    websiteUrl: 'https://reverseimagelocation.com/',
    featured: false,
    pros: [
      'Explains visual clues behind location estimates',
      'Works with photos and screenshots without GPS metadata',
      'Useful for OSINT, geography learning, and travel research',
      'Encourages evidence-based verification',
    ],
    cons: [
      'Pinpoint accuracy depends on visible scene evidence',
      'Full location details and map access require a premium plan',
      'Results should be verified with independent sources',
    ],
    alternatives: ['image-describer'],
  },
]
